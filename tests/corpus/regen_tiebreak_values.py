...
output::
    ...
    python tests/corpus/regen_tiebreak_values.py --limit 50 --output /tmp/part.jsonl
...
CORPUS = Path(CORPUS_DIR) / "corpus.jsonl"
BASELINE = Path(CORPUS_DIR) / "tiebreak_values.jsonl"
