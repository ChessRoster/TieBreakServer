...
tests/corpus/README.md records that no fixture in the corpus carries an XXZ record: the
corpus was generated by writing TRFs out of the engine's own JSON, and the writer does not
emit one (its "write" entry is output_trf_noop).
"""
import os
