...
None of this shows in the fixtures. tests/corpus/README.md records that the corpus was
generated by writing TRFs out of the engine's own JSON, so it contains no 362 record at
all and no 162 record whose "A" or "X" field carries a value the ordinary score system
