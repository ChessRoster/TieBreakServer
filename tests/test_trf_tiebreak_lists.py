...
tests/corpus/README.md records that no fixture in the 6,000-file corpus carries a 202
record at all: the corpus was generated by writing TRFs out of the engine's own JSON, and
the writer does not emit one.
"""
import decimal
